                ...
                <div class="px-4 pt-4">
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" email="email" />
                            @error('email')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" password_confirmation="password_confirmation" />
